...
export const Register = () => {
  return (
    <form onSubmit={() => null}>
      <div className="flex flex-col w-full">
        <div className="flex flex-col">
          <label htmlFor="username" className="text-gray-500 text-left py-2">Email address</label>
    ...
    <Button onClick={() => console.log("test")} text="Register" colorType={ColorTypes.DARK} />
    <div className="flex justify-between w-full items-center">
      <hr className="flex-grow border-t border-gray-400 mx-4" />
      <h5 className="text-gray-500">or</h5>
      <hr className="flex-grow border-t border-gray-400 mx-4" />
    </div>
    <Button onClick={() => registerSignInVar(RegisterSignInType.SIGNIN)} text="Sign In" colorType={ColorTypes.LIGHT} />
      </div>
    </form>
  );
};
